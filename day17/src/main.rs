...
impl Scene {
    fn load(active_positions: Vec<(i32, i32)>) -> Scene {
    ...
    fn new(data: HashSet<(i32, i32, i32)>, limits: ((i32, i32), (i32, i32), (i32, i32))) -> Scene {
        Scene{data, x_limits : limits.0, y_limits : limits.1, z_limits : limits.2}
    }
...
fn main() {
    ...
    let final_state = (0..6).fold(Scene::load(values), |scene, _| {
        scene.run_cycle()
    });
